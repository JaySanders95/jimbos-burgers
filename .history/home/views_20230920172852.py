...
def menu(request):
    ...
    sides = [
        {"side_name": "Fries", "description": "Your choice of regular fries.", "price": "£2.50"},
        {"side_name": "Onion Rings", "description": "Crispy fried onion rings.", "price": "£3.00"},
        {"side_name": "Coleslaw", "description": "Freshly made creamy coleslaw.", "price": "£2.00"},
        {"side_name": "Side Salad", "description": "Mixed greens with a light dressing.", "price": "£3.50"},
        {"side_name": "Dirty Fries", "description": "Fries with cheese sauce, bacon and jalapenos.", "price": "£4.50"}
    ]

    drinks = [
        {"drink_name": "Coca-Cola/Diet", "price": "£2"},
        {"drink_name": "Fanta", "price": "£2"},
        {"drink_name": "Dr.Pepper", "price": "£2"},
        {"drink_name": "Iced Coffee", "price": "£3.5"},
        {"drink_name": "5 Dollar shake", "price": "£2"},
        {"drink_name": "Water", "price": "£2"},
    ]
