...
class BookingCreateViewTest(TestCase):
    ...
    def test_booking_create_view(self):
        ...
        """
        code would not allow this as it would not let me make a booking on the local database
        but the bookings would work when connected to usuall database
        """
        #Check if booking was made
        #self.assertEqual(Booking.objects.count(), 1)

         #Check if booking has correct user and table
