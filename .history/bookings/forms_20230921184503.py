...
class BookingForm(forms.ModelForm):
    class Meta:
        model = Booking
        fields = ['customer_name', 'party_size_for_booking', 'booking_date', 'booking_time', 'booking_table', 'booking_notes']
        ...
        labels = {
            ...
            'party_size_for_booking' : "Party Size",
        ...
        widgets = {
            ...
            'booking_table' : forms.Select(attrs={'class' : 'form-control'})
        }
        ...
        error_messages = {
            ...
            'booking_table': {
                'required': 'Booking table is required.'
            },
            'party_size_for_booking' : {
